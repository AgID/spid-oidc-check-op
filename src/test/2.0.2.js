...
class Test_2_0_2 extends TestAuthRequest {

    constructor(metadata, authrequest={}) {
        super(metadata, authrequest);
        this.num = "2.0.2";
        this.description = "Request correct, prompt=consent login, scope=openid, acr_values=https://www.spid.gov.it/SpidL2";
