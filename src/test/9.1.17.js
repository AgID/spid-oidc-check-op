...
class Test_9_1_17 extends TestIntrospectionRequest {
    ...
    constructor(metadata, authrequest, authresponse, tokenrequest, tokenresponse, userinforequest, userinforesponse, introspectionrequest) {
        ...
        this.num = "9.1.17";
        this.description = "Introspection Request Wrong - the value of jti is less of 16 byte length ";
