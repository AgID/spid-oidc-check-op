...
class Test_8_2_25 extends TestTokenResponse {

    constructor(metadata, authrequest, authresponse, tokenrequest, tokenresponse) {
        super(metadata, authrequest, authresponse, tokenrequest, tokenresponse);
        this.num = "8.2.25";
        this.description = "Grant Token JWS (Grant Token Inner Signed Token) - claim jti SHOULD be present";
