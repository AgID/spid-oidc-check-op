...
class Test_9_1_7 extends TestIntrospectionRequest {
    ...
    constructor(metadata, authrequest, authresponse, tokenrequest, tokenresponse, userinforequest, userinforesponse, introspectionrequest) {
        ...
        this.num = "9.1.7";
        this.description = "Introspection Request Wrong - the value of sub in the client_assertion is different from the value of iss";
