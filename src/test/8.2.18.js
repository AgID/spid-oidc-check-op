...
class Test_8_2_18 extends TestTokenResponse {

    constructor(metadata, authrequest, authresponse, tokenrequest, tokenresponse) {
        super(metadata, authrequest, authresponse, tokenrequest, tokenresponse);
        this.num = "8.2.18";
        this.description = "Grant Token JWS (Grant Token Inner Signed Token) - claim nbf SHOULD be present";
    ...
    async exec() {
        ...
        for(let t in id_token_payload.tokens) {
            ...
            if(grantTokenInnerSignedTokenPayload.nbf==null || grantTokenInnerSignedTokenPayload.nbf=='') {
                this.notes = grantTokenInnerSignedTokenPayload.nbf;
                throw("grant token JWS (Grant Token Inner Signed Token) claim nbf SHOULD be present");
            }          
        }
