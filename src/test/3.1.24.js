...
class Test_3_1_24 extends TestTokenRequest {
  constructor(metadata, authrequest = {}, authresponse = {}, tokenrequest) {
    super(metadata, authrequest, authresponse, tokenrequest);
    this.num = "3.1.24";
    this.description =
      "Wrong Token Request:the value of grant_type is not one of ['authorization_code', 'refresh_token']";
