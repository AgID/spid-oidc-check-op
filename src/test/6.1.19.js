...
class Test_6_1_19 extends TestRevocationRequest {
  constructor(
    metadata,
    authrequest,
    authresponse,
    ...
    this.num = '6.1.19';
    this.description =
      'the value of client_assertion_type is different from "urn:ietf:params:oauth:client-assertion-type:jwt-bearer"';
