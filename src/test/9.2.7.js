...
class Test_9_2_7 extends TestIntrospectionResponse {
    ...
    constructor(metadata, authrequest, authresponse, tokenrequest, tokenresponse, userinforequest, userinforesponse, introspectionrequest, introspectionresponse) {
        ...
        this.num = "9.2.7";
        this.description = "Introspection Response - if active=true, parameter sub MUST be present";
    ...
    exec() {
        ...
        this.notes = this.introspectionresponse.data.sub;
        return true;
    }

}

module.exports = Test_9_2_7