...
class Test_2_2_4 extends TestAuthRequest {

    constructor(metadata, authrequest={}) {
        super(metadata, authrequest);
        this.num = "2.2.4";
        this.description = "Request correct, prompt=consent, scope=openid offline_access, acr_values=https://www.spid.gov.it/SpidL3 https://www.spid.gov.it/SpidL1";
    ...
    async exec() {
        ...
        this.authrequest.prompt = "consent";
        this.authrequest.redirect_uri = config_rp.redirect_uri;
        this.authrequest.acr_values = "https://www.spid.gov.it/SpidL3 https://www.spid.gov.it/SpidL1";
