...
class Test_9_1_19 extends TestIntrospectionRequest {
    ...
    constructor(metadata, authrequest, authresponse, tokenrequest, tokenresponse, userinforequest, userinforesponse, introspectionrequest) {
        ...
        this.num = "9.1.19";
        this.description = "Introspection Request Wrong - the value of client_assertion_type is different from 'urn:ietf:params:oauth:client-assertion-type:jwt-bearer'";
    ...
    async exec() {
        ...
        this.introspectionrequest.client_assertion_type = "differentfrom_urn:ietf:params:oauth:client-assertion-type:jwt-bearer";
