...
class Test_8_2_5 extends TestTokenResponse {

    constructor(metadata, authrequest, authresponse, tokenrequest, tokenresponse) {
        super(metadata, authrequest, authresponse, tokenrequest, tokenresponse);
        this.num = "8.2.5";
        this.description = "Grant Token JWS (Grant Token Inner Signed Token) - the value of iss MUST be a valid URL";
    ...
    async exec() {
        ...
        for(let t in id_token_payload.tokens) {
            ...
            if(!validator.isURL(grantTokenInnerSignedTokenPayload.iss)) {
                this.notes = grantTokenInnerSignedTokenPayload.iss;
                throw("GrantToken JWS (Grant Token Inner Signed Token) claim iss is not a valid URL");
            }            
        }
