...
class Test_5_1_6 extends TestIntrospectionRequest{
    constructor(introspection){
        super(introspection);
        this.num="5.1.6";
        this.description="Wrong Introspection Request: the claim sub in the client_assertion is not present";
