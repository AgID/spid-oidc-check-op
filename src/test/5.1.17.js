...
class Test_5_1_17 extends TestIntrospectionRequest {
  constructor(
    metadata,
    authrequest,
    authresponse,
    ...
    this.num = '5.1.17';
    this.description =
      'Wrong Introspection Request:the value of jti is less of 16 byte length';
  ...
  async exec() {
    ...
    let payload = JSON.stringify({
      jti: Utility.getUUID().substr(0, 15),
