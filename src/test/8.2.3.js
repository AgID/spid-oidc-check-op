...
class Test_8_2_3 extends TestTokenResponse {

    constructor(metadata, authrequest, authresponse, tokenrequest, tokenresponse) {
        super(metadata, authrequest, authresponse, tokenrequest, tokenresponse);
        this.num = "8.2.3";
        this.description = "Grant Token JWS (Grant Token Inner Signed Token) - the signature of Grant Token Inner Signed Token MUST be able to be verified with the public key of the OP";
    ...
    async exec() {
        ...
        for(let t in id_token_payload.tokens) {
            ...
            if(!jws) {
                this.notes = jws;
                throw("the signature of Grant Token Inner Signed Token cannot be verified with the public key of the OP");
            }     
        }
