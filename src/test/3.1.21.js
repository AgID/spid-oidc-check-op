...
class Test_3_1_21 extends TestTokenRequest {

    constructor(metadata, authrequest={}, authresponse={}, tokenrequest) {
        super(metadata, authrequest, authresponse, tokenrequest);
        this.num = "3.1.21";
        this.description = "Wrong Token Request:parameter client_assertion_type is not present"
