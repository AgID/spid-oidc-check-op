...
class Test_9_2_13 extends TestIntrospectionResponse {
    ...
    constructor(metadata, authrequest, authresponse, tokenrequest, tokenresponse, userinforequest, userinforesponse, introspectionrequest, introspectionresponse) {
        ...
        this.num = "9.2.13";
        this.description = "Introspection Response - if active=true, parameter aud MUST be present";
