...
class Test_2_2_5 extends TestAuthRequest {

    constructor(metadata, authrequest={}) {
        super(metadata, authrequest);
        this.num = "2.2.5";
        this.description = "Request correct, prompt=consent, scope=openid offline_access, acr_values=https://www.spid.gov.it/SpidL1 https://www.spid.gov.it/SpidL2";
    ...
    async exec() {
        ...
        this.authrequest.acr_values = "https://www.spid.gov.it/SpidL1 https://www.spid.gov.it/SpidL2";
