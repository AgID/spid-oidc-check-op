...
class Test_1_3_22 extends TestMetadata {

    constructor(metadata) {
        super(metadata);
        this.num = "1.3.22";
        this.description = "The metadata MUST contain the claim request_object_signing_alg_values_supported";
