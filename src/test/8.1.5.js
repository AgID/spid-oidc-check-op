...
class Test_8_1_5 extends TestTokenResponse {

    constructor(metadata, authrequest, authresponse, tokenrequest, tokenresponse) {
        super(metadata, authrequest, authresponse, tokenrequest, tokenresponse);
        this.num = "8.1.5";
        this.description = "Grant Token JWE: the value of typ MUST be 'aa-grant+jwt'";
    ...
    async exec() {
        ...
        for(let t in id_token_payload.tokens) {
            ...
            if(jwe.header.typ!='aa-grant+jwt') {
                this.notes = jwe.header.typ;
                throw("the value of typ is not 'aa-grant+jwt'");
            }
        }
