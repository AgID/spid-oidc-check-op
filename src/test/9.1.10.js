...
class Test_9_1_10 extends TestIntrospectionRequest {
    ...
    constructor(metadata, authrequest, authresponse, tokenrequest, tokenresponse, userinforequest, userinforesponse, introspectionrequest) {
        ...
        this.num = "9.1.10";
        this.description = "Introspection Request Wrong - the claim iat in the client_assertion is not present";
