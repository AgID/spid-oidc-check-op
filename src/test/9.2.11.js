...
class Test_9_2_11 extends TestIntrospectionResponse {
    ...
    constructor(metadata, authrequest, authresponse, tokenrequest, tokenresponse, userinforequest, userinforesponse, introspectionrequest, introspectionresponse) {
        ...
        this.num = "9.2.11";
        this.description = "Introspection Response - if active=true, parameter iss MUST be present";
