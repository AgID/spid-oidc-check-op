...
class Test_2_2_1 extends TestAuthRequest {

    constructor(metadata, authrequest={}) {
        super(metadata, authrequest);
        this.num = "2.2.1";
        this.description = "Request correct, prompt=consent, scope=openid, acr_values=https://www.spid.gov.it/SpidL2";
