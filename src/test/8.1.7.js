...
class Test_8_1_7 extends TestTokenResponse {

    constructor(metadata, authrequest, authresponse, tokenrequest, tokenresponse) {
        super(metadata, authrequest, authresponse, tokenrequest, tokenresponse);
        this.num = "8.1.7";
        this.description = "Grant Token JWE: the payload MUST be a valid JWS (Grant Token Inner Signed Token)";
