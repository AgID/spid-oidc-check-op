...
class Test_8_2_14 extends TestTokenResponse {

    constructor(metadata, authrequest, authresponse, tokenrequest, tokenresponse) {
        super(metadata, authrequest, authresponse, tokenrequest, tokenresponse);
        this.num = "8.2.14";
        this.description = "Grant Token JWS (Grant Token Inner Signed Token) - the value of iat MUST be a valid unix time";
