...
class Test_5_1_19 extends TestIntrospectionRequest{
    constructor(introspection){
        super(introspection);
        this.num="5.1.19";
        this.description="Wrong Introspection Request:the value of client_assertion_type is different from 'urn:ietf:params:oauth:client-assertion-type:jwt-bearer'";
