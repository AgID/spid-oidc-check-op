...
class Test_9_1_18 extends TestIntrospectionRequest {
    ...
    constructor(metadata, authrequest, authresponse, tokenrequest, tokenresponse, userinforequest, userinforesponse, introspectionrequest) {
        ...
        this.num = "9.1.18";
        this.description = "Introspection Request Wrong - parameter client_assertion_type is not present";
    ...
    async exec() {
        ...
        //this.introspectionrequest.client_assertion_type = "urn:ietf:params:oauth:client-assertion-type:jwt-bearer";   // REMOVED
