...
class Test_4_4_8 extends TestUserinfoResponse {
  constructor(metadata, authrequest, authresponse, tokenrequest, tokenresponse, userinforequest, userinforesponse) {
    ...
    this.num = "4.4.8";
    this.description = "Userinfo Signed Token Payload: the value of aud MUST be equal to the client_id of RP";
  ...
  async exec() {
    ...
    if (userinfo_sig_token_verified.payload.aud != config_rp.client_id) {
