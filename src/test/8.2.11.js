...
class Test_8_2_11 extends TestTokenResponse {

    constructor(metadata, authrequest, authresponse, tokenrequest, tokenresponse) {
        super(metadata, authrequest, authresponse, tokenrequest, tokenresponse);
        this.num = "8.2.11";
        this.description = "Grant Token JWS (Grant Token Inner Signed Token) - claim acr MUST be present";
