...
class Test_1_3_21 extends TestMetadata {

    constructor(metadata) {
        super(metadata);
        this.num = "1.3.21";
        this.description = "The metadata MUST contain the claim userinfo_encryption_enc_values_supported";
