...
class Test_6_1_21 extends TestRevocationRequest {
  constructor(
    metadata,
    authrequest,
    authresponse,
    ...
    this.num = '6.1.21';
    this.description = 'the value of client_id is not trusted';
    this.validation = 'self';
  }
  async exec() {
    this.revocationrequest.client_id = 'invalid_client_id';
