...
class Test_8_2_9 extends TestTokenResponse {

    constructor(metadata, authrequest, authresponse, tokenrequest, tokenresponse) {
        super(metadata, authrequest, authresponse, tokenrequest, tokenresponse);
        this.num = "8.2.9";
        this.description = "Grant Token JWS (Grant Token Inner Signed Token) - claim sid MUST be present";
