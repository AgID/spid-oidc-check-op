...
class Test_2_1_21 extends TestAuthRequest {
  constructor(metadata, authrequest = {}) {
    super(metadata, authrequest);
    this.num = '2.1.21';
    this.description =
      'Wrong Authentication Request: the value of prompt is different from ["consent", "consent_login"]';
  ...
  async exec() {
    ...
    this.authrequest.prompt = 'different_from_consent_consent_login';
