...
class Test_2_2_3 extends TestAuthRequest {

    constructor(metadata, authrequest={}) {
        super(metadata, authrequest);
        this.num = "2.2.3";
        this.description = "Request correct, prompt=consent, scope=openid offline_access, acr_values=https://www.spid.gov.it/SpidL2 https://www.spid.gov.it/SpidL1";
    ...
    async exec() {
        ...
        this.authrequest.acr_values = "https://www.spid.gov.it/SpidL2 https://www.spid.gov.it/SpidL1";
