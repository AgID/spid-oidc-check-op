...
class Test_3_4_1 extends TestTokenResponse {

    constructor(metadata, authrequest, authresponse, tokenrequest, tokenresponse) {
        super(metadata, authrequest, authresponse, tokenrequest, tokenresponse);
        this.num = "3.4.1";
        this.description = "Access Token Header: the value of alg MUST be one of ['RS256', 'RS512']";
    ...
    exec() {
        ...
        if(!allowed_alg.includes(access_token_header.alg)) {
