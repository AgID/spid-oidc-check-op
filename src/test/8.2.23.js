...
class Test_8_2_23 extends TestTokenResponse {

    constructor(metadata, authrequest, authresponse, tokenrequest, tokenresponse) {
        super(metadata, authrequest, authresponse, tokenrequest, tokenresponse);
        this.num = "8.2.23";
        this.description = "Grant Token JWS (Grant Token Inner Signed Token) - act object MUST contain claim sub";
