...
class Test_3_1_25 extends TestTokenRequest {

    constructor(metadata, authrequest={}, authresponse={}, tokenrequest) {
        super(metadata, authrequest, authresponse, tokenrequest);
        this.num = "3.1.25";
        this.description = "Wrong token request:the value of grant_type is 'authorization_code' and parameter code is not present"
