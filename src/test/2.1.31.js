...
class Test_2_1_31 extends TestAuthRequest {
  constructor(metadata, authrequest = {}) {
    super(metadata, authrequest);
    this.num = '2.1.31';
    this.description =
      'Wrong Authentication Request: state length is less than 32 chars';
  ...
  async exec() {
    ...
    let payload = JSON.stringify({
      ...
      state: this.authrequest.state.substr(0, 31),
    });
