...
class Test_3_1_2 extends TestTokenRequest {

    constructor(metadata, authrequest={}, authresponse={}) {
        super(metadata, authrequest, authresponse);
        this.num = "3.1.2";
        this.description = "Wrong Token Request: the value of client_id is not trusted";
        this.validation = "self";
    }

    async exec() {
        this.tokenrequest.client_id = "invalid_client_id";
