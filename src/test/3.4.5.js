...
class Test_3_4_5 extends TestTokenResponse {

    constructor(metadata, authrequest, authresponse, tokenrequest, tokenresponse) {
        super(metadata, authrequest, authresponse, tokenrequest, tokenresponse);
        this.num = "3.4.5";
        this.description = "Access Token Payload: the value of iss MUST be equal to the URL of the OP";
    ...
    exec() {
        ...
        if(!this.metadata.url.includes(access_token_payload.iss)) {
            this.notes = access_token_payload.iss;
