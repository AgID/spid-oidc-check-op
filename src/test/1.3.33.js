...
class Test_1_3_33 extends TestMetadata {
  constructor(metadata) {
    super(metadata);
    this.num = '1.3.33';
    this.description = 'The value of code_challenge_methods_supported MUST be a valid JSON array';
