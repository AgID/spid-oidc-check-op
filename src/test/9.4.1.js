...
class Test_9_4_1 extends TestIntrospectionResponse {
    ...
    constructor(metadata, authrequest, authresponse, tokenrequest, tokenresponse, userinforequest, userinforesponse, introspectionrequest, introspectionresponse) {
        ...
        this.num = "9.4.1";
        this.description = "Introspection Response MUST have active=false";
    ...
    exec() {
        ...
        if(this.introspectionresponse.data.active!=false) {
            this.notes = this.introspectionresponse.data;
            throw("the parameter active MUST be false");
        }
