...
class Test_8_2_4 extends TestTokenResponse {

    constructor(metadata, authrequest, authresponse, tokenrequest, tokenresponse) {
        super(metadata, authrequest, authresponse, tokenrequest, tokenresponse);
        this.num = "8.2.4";
        this.description = "Grant Token JWS (Grant Token Inner Signed Token) - claim iss MUST be present";
