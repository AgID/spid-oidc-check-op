...
class Test_8_0_3 extends TestTokenResponse {

    constructor(metadata, authrequest, authresponse, tokenrequest, tokenresponse) {
        super(metadata, authrequest, authresponse, tokenrequest, tokenresponse);
        this.num = "8.0.3";
        this.description = "Attribute Authority Grant Token: objects in tokens array MUST contain claim aud";
    ...
    exec() {
        ...
        for(let t in id_token_payload.tokens) {
            ...
            if(token==null || token.aud==null || token.aud=='') {
                this.notes = token;
                throw("an object in tokens array does not contain claim aud");
            }
        }
