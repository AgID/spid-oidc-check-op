...
class Test_2_2_2 extends TestAuthRequest {

    constructor(metadata, authrequest={}) {
        super(metadata, authrequest);
        this.num = "2.2.2";
        this.description = "Request correct, prompt=consent, scope=openid, acr_values=https://www.spid.gov.it/SpidL3";
