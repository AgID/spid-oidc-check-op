...
class Test_9_1_15 extends TestIntrospectionRequest {
    ...
    constructor(metadata, authrequest, authresponse, tokenrequest, tokenresponse, userinforequest, userinforesponse, introspectionrequest) {
        ...
        this.num = "9.1.15";
        this.description = "Introspection Request Wrong - the value of exp is < current date+3min";
    ...
    async exec() {
        ...
        let iat = moment();
        let exp = iat.clone().subtract(10, 'm');
