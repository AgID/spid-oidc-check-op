...
class Test_8_2_2 extends TestTokenResponse {

    constructor(metadata, authrequest, authresponse, tokenrequest, tokenresponse) {
        super(metadata, authrequest, authresponse, tokenrequest, tokenresponse);
        this.num = "8.2.2";
        this.description = "Grant Token JWS (Grant Token Inner Signed Token) - claim kid MUST be present";
    ...
    async exec() {
        ...
        for(let t in id_token_payload.tokens) {
            ...
            if(jws.header.kid==null || jws.header.kid=='') {
                ...
                throw("grant token JWS (Grant Token Inner Signed Token) claim kid is not present");
            }     
        }
