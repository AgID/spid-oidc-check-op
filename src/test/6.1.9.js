...
class Test_6_1_9 extends TestRevocationRequest {
  constructor(
    metadata,
    authrequest,
    authresponse,
    ...
    this.num = '6.1.9';
    this.description =
      'the value of aud in the client_assertion is different from the URL of revocation endpoint';
