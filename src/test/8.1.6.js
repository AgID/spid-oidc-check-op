...
class Test_8_1_6 extends TestTokenResponse {

    constructor(metadata, authrequest, authresponse, tokenrequest, tokenresponse) {
        super(metadata, authrequest, authresponse, tokenrequest, tokenresponse);
        this.num = "8.1.6";
        this.description = "Grant Token JWE: The Encrypted Grant Token MUST be able to be decrypted with the private key of the destination AA";
    ...
    async exec() {
        ...
        for(let t in id_token_payload.tokens) {
            ...
            if(!jwe) {
                this.notes = jwe;
                throw("The Encrypted Grant Token cannot be decrypted with the private key of the destination AA");
