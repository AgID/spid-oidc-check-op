...
class Test_3_1_12 extends TestTokenRequest {
  constructor(metadata, authrequest = {}, authresponse = {}, tokenrequest) {
    super(metadata, authrequest, authresponse, tokenrequest);
    this.num = "3.1.12";
    this.description =
      "Wrong Token Request:the value of aud in the client_assertion is different from the URL of token endpoint";
  ...
  async exec() {
    ...
    let payload = JSON.stringify({
      ...
      aud: "different_from_url_of_token_endpoint",
      iat: iat.unix(),
      exp: exp.unix(),
