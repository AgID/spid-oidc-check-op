...
class Test_5_1_2 extends TestIntrospectionRequest {
  constructor(
    metadata,
    authrequest,
    authresponse,
    ...
    this.num = '5.1.2';
    this.description =
      'Wrong Introspection Request: the value of client_assertion is not a valid JWT';
    this.validation = 'self';
  }
  async exec() {
    this.introspectionrequest.client_id = '';
