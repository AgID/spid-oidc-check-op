...
class Test_4_4_4 extends TestUserinfoResponse {
  constructor(metadata, authrequest, authresponse, tokenrequest, tokenresponse, userinforequest, userinforesponse) {
    ...
    this.num = "4.4.4";
    this.description = "Userinfo Signed Token Payload: claim iss MUST be present";
  ...
  async exec() {
    ...
    if (userinfo_sig_token_verified.payload.iss == null || userinfo_sig_token_verified.payload.iss == "") {
      this.notes = userinfo_sig_token_verified.payload.toString();
