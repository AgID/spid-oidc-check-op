...
class Test_3_1_31 extends TestTokenRequest {
  constructor(metadata, authrequest = {}, authresponse = {}, tokenrequest) {
    ...
    this.num = "3.1.31";
    this.description =
      "Wrong Token Request:the value of redirect_uri is different from the value of redirect_uri sent with the authorization request";
  ...
  async exec() {
    ...
    this.tokenrequest.refresh_token = this.authrequest.refresh_token;
    this.tokenrequest.client_assertion_type = "urn:ietf:params:oauth:client-assertion-type:jwt-bearer";
    this.tokenrequest.redirect_uri = "different_from_authrequest_redirect_uri";
