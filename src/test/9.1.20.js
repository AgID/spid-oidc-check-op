...
class Test_9_1_20 extends TestIntrospectionRequest {
    ...
    constructor(metadata, authrequest, authresponse, tokenrequest, tokenresponse, userinforequest, userinforesponse, introspectionrequest) {
        ...
        this.num = "9.1.20";
        this.description = "Introspection Request Wrong - parameter client_id is not present";
    ...
    async exec() {
        ...
        //this.introspectionrequest.client_id = config_rp.client_id;    // REMOVED
