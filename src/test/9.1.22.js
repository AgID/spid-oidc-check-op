...
class Test_9_1_22 extends TestIntrospectionRequest {
    ...
    constructor(metadata, authrequest, authresponse, tokenrequest, tokenresponse, userinforequest, userinforesponse, introspectionrequest) {
        ...
        this.num = "9.1.22";
        this.description = "Introspection Request Wrong - parameter token is not present";
    ...
    async exec() {
        ...
        //this.introspectionrequest.token = grant_tokens[0];    // REMOVED
