...
class Test_2_1_1 extends TestAuthRequest {
  constructor(metadata, authrequest = {}) {
    super(metadata, authrequest);
    this.num = '2.1.1';
    this.description =
      'Wrong Authentication Request: the value of request is not a valid JWT. Expected: Error on OP.';
