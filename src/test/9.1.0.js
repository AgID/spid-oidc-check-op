...
class Test_9_1_0 extends TestIntrospectionRequest {
    ...
    constructor(metadata, authrequest, authresponse, tokenrequest, tokenresponse, userinforequest, userinforesponse, introspectionrequest) {
        ...
        this.num = "9.1.0";
        this.description = "Introspection Request Wrong - the request is sent using HTTP method different from POST";
        this.validation = "self";
    }

    async exec() {

        this.setVar('method', 'put');
