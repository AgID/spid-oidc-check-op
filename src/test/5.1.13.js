...
class Test_5_1_13 extends TestIntrospectionRequest{
    constructor(introspection){
        super(introspection);
        this.num="5.1.13";
        this.description="Wrong Introspection Request:the claim exp in the client_assertion is not present";
