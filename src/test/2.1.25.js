...
class Test_2_1_25 extends TestAuthRequest {
  constructor(metadata, authrequest = {}) {
    super(metadata, authrequest);
    this.num = '2.1.25';
    this.description =
      'Wrong Authentication Request: values of acr_values are different from ["https://www.spid.gov.it/SpidL1", "https://www.spid.gov.it/SpidL2", "https://www.spid.gov.it/SpidL3"]';
  ...
  async exec() {
    ...
    this.authrequest.acr_values = 'https://www.spid.gov.it/SpidL4';
