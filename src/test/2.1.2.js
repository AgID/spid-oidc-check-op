...
class Test_2_1_2 extends TestAuthRequest {
  constructor(metadata, authrequest = {}) {
    super(metadata, authrequest);
    this.num = '2.1.2';
    this.description =
      'Wrong Authentication Request: the signature of the request JWT is not valid. Expected: Error on OP.';
