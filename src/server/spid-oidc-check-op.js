...
app.use((req, res, next) => {
  console.log(".\n.\n.");
  Utility.log(
    moment().format("YYYY-MM-DD HH:mm:ss") + " - " + req.method + " [" + req.ips.join(" - ") + "] " + req.path
  );
  next();
});
...
var authenticator = config_rp.agidloginAuthentication ? new Authenticator("validator") : null;
